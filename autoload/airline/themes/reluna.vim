" vim-airline companion theme of reluna
" (https://github.com/Pychimp/vim-reluna)

let g:airline#themes#reluna#palette = {}

let g:airline#themes#reluna#palette.accents = {
      \ 'red': [ '#ffffff' , '' , 231 , '' , '' ],
      \ }
...
let g:airline#themes#reluna#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
let g:airline#themes#reluna#palette.insert_modified = {
      \ 'airline_c': [ '#ffffff' , '#005e5e' , 255     , 52      , ''     ] ,
      \ }
let g:airline#themes#reluna#palette.insert_paste = {
...
let g:airline#themes#reluna#palette.normal_modified.airline_warning =
    \ g:airline#themes#reluna#palette.normal.airline_warning

let g:airline#themes#reluna#palette.insert.airline_warning =
    \ g:airline#themes#reluna#palette.normal.airline_warning

let g:airline#themes#reluna#palette.insert_modified.airline_warning =
    \ g:airline#themes#reluna#palette.normal.airline_warning

let g:airline#themes#reluna#palette.visual.airline_warning =
    \ g:airline#themes#reluna#palette.normal.airline_warning

let g:airline#themes#reluna#palette.visual_modified.airline_warning =
    \ g:airline#themes#reluna#palette.normal.airline_warning

let g:airline#themes#reluna#palette.replace.airline_warning =
    \ g:airline#themes#reluna#palette.normal.airline_warning

let g:airline#themes#reluna#palette.replace_modified.airline_warning =
    \ g:airline#themes#reluna#palette.normal.airline_warning
...
let g:airline#themes#reluna#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
